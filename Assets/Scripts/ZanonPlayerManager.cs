...
public class ZanonPlayerManager : MonoBehaviour
{
    ...
    public void OnAttack(InputValue value)
    {
        ...
        float intensity = 10f;
        ballRB.AddForce(direction*intensity, ForceMode.Impulse);
    }

    public void OnCreateBall(InputValue value)
    {
        SpawnManager manager = GameObject.FindFirstObjectByType<SpawnManager>();
        manager.CreateBall();
    }
}
